/*
	*
	* PBStartUpWizard.cpp - A simple startup wizard for PiBreeze
	*
*/

#include "PBStartupWizard.hpp"

PBStartupWizard::PBStartupWizard( QWidget *parent ) : QWizard( parent ) {
...
void PBStartupWizard::createGui() {
...
void PBStartupWizard::createPages() {
	...
	QLabel *p1lbl1 = new QLabel( "<center><h3>Welcome to PiBreeze v3.0</h3><h4>The super fast file browser</h4></center>" );
	...
	QLabel *p1lbl3 = new QLabel(
		"<p>Press <tt><b>Next</b></tt> to see what new features PiBreeze v3 brings to you and if you want, configure PiBreeze.</p>"
		"<p>If you would like to be surprised by the new features, you may press <tt><b>Skip</b></tt> and open PiBreeze with preset default settings.</p>"
	...
	QLabel *p3lbl1 = new QLabel(
		"<p>In PiBreeze, folder contents can be shown in three ways as Icons, Tiles or Details.</p>"
	...
	QLabel *p6lbl1 = new QLabel(
		"<p>By default, PiBreeze shows an icon corresponding to the type of file in question However in some cases, "
		"it is capable of showing the contents of the file, to a limited extent. These previews are called file thumbnails. "
		"Currently PiBreeze can show the preview of only images. Preview of other files may be enables in the future.</p>"
		"<p>Do you want to show image thumbnails by default?</p>"
	);
	p6lbl1->setWordWrap( true );

	p6cb1 = new QCheckBox( "Show thumbnails of images in PiBreeze" );
	...
	QLabel *p6lbl2 = new QLabel(
		...
		"faster loading of thumbnails, PiBreeze maintains a cache of these generated thumbnails. This consumes a typical "
	...
	QLabel *pLlbl1 = new QLabel(
		"<center><h3>Thank you for choosing PiBreeze v3.0</h3></center>"
	);

	QLabel *pLlbl2 = new QLabel(
		"<center><p>Hope your experience with PiBreeze is a pleasant one.</p><br style='line-height: 5%;'>"
		"<p><a href = 'mailto:marcusbritanicus@gmail.com'>Drop in</a> a word of appreciation if you enjoyed the experience, and "
		"feel free to distribute PiBreeze to all your family, friends and colleagues.</p><br style='line-height: 5%;'>"
		"<p>If you stumbled across an annoying bug which ruined your time, do not hesitate to file a bug report "
		"<a href = 'https://github.com/marcusbritanicus/PiBreeze/issues/new'>here</a>.</p></center>"
	);
...
void PBStartupWizard::setupConnections() {
...
void PBStartupWizard::setWindowProperties() {
	...
	*/
	...
	setWindowTitle( "PiBreeze Startup Wizard" );
	setWindowIcon( QIcon::fromTheme( "pibreeze" ) );
...
void PBStartupWizard::saveSettings() {

	close();
};

void PBStartupWizard::paintEvent( QPaintEvent *pEvent ) {
