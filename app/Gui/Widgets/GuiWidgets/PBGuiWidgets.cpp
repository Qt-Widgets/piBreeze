/*
	*
	* PBGuiWidgets.cpp - The GUI classes for PiBreeze
	*
*/
...
PBLineEdit::PBLineEdit( QWidget *parent ) : QLineEdit( parent ) {

	setMinimumHeight( 32 );
};

void PBLineEdit::paintEvent( QPaintEvent *pEvent ) {

	QLineEdit::paintEvent( pEvent );
	pEvent->accept();
};

PBDriveInfo::PBDriveInfo( PBDeviceInfo dInfo, QWidget *parent ) : QWidget ( parent ) {
...
void PBDriveInfo::paintEvent( QPaintEvent *pEvent ) {
