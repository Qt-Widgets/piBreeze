...
DEPENDPATH += . QTermWidget/lib ../../common/ ../../common/include
INCLUDEPATH += . QTermWidget/lib ../../common/ ../../common/include
...
unix {
	...
	target.path = $$PREFIX/lib/pibreeze/plugins
}
