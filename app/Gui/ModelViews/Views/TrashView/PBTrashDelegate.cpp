/*
	*
	* PBTrashDelegate.cpp - ItemDelegate Class for PBTrashView class
	*
*/
...
void PBTrashDelegate::paint( QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index ) const {
	...
	if ( index.column() != 0 )
		...
		const PBTrashModel *model = static_cast<const PBTrashModel*>( index.model() );
...
void PBTrashDelegate::paintExtraDetails( QPainter *painter, QList<QRect> &textRectList, const QModelIndex &index ) const {
