/*
	*
	* PBVfsView.hpp - PBVfsView.cpp header file
	*
*/
...
class PBVfsIcon : public QWidget {
	Q_OBJECT
...
class PBVfsAction : public QWidget {
	Q_OBJECT

	public:
		PBVfsAction( PBDeviceInfo, QWidget* );
		QString mountPoint();
...
class PBVfsMenu : public QMenu {
	Q_OBJECT

	public:
		PBVfsMenu( QWidget *parent );
