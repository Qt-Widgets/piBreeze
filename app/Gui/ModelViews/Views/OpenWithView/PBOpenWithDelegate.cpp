...
#include "PBOpenWithDelegate.hpp"

void PBOpenWithDelegate::paint( QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index ) const {

	if ( index.column() != 0 )
		QItemDelegate::paint( painter, option, index );

	else {
		// const PBApplicationsModel *model = static_cast<const PBApplicationsModel*>( index.model() );
