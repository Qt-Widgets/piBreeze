/*
	*
	* PBTrashView.cpp - PiBreeze TrashView Class
	*
*/

#include "PBTrashView.hpp"

PBTrashView::PBTrashView( PBTrashModel *model ) : QAbstractItemView() {
	...
	setItemDelegate( new PBTrashDelegate() );
...
void PBTrashView::updateViewMode() {
...
int PBTrashView::categoryHeight() const {

	return myCategoryHeight;
};

void PBTrashView::setCategoryHeight( int newCategoryHeight ) {
...
QSize PBTrashView::iconSize() const {

	return myIconSize;
};

void PBTrashView::setIconSize( QSize newIconSize ) {
...
void PBTrashView::setIconSize( int nWidth, int nHeight ) {

	setIconSize( QSize( nWidth, nHeight ) );
};

QMargins PBTrashView::contentsMargins() const {

	return myContentsMargins;
};

void PBTrashView::setContentsMargins( QMargins newContentsMargins ) {
...
void PBTrashView::setContentsMargins( int nLeft, int nTop, int nRight, int nBottom ) {

	setContentsMargins( QMargins( nLeft, nTop, nRight, nBottom ) );
};

QMargins PBTrashView::inlayMargins() const {

	return myInlayMargins;
};

void PBTrashView::setInlayMargins( QMargins newInlayMargins ) {
...
void PBTrashView::setInlayMargins( int nLeft, int nTop, int nRight, int nBottom ) {
...
int PBTrashView::categorySpacing() const {

	return myCategorySpacing;
};

void PBTrashView::setCategorySpacing( int newCategorySpacing ) {
...
QRect PBTrashView::visualRect( const QModelIndex &index ) const {
...
QRect PBTrashView::categoryRect( int categoryIndex ) const {
...
void PBTrashView::scrollTo( const QModelIndex &index, QAbstractItemView::ScrollHint ) {
...
QModelIndex PBTrashView::indexAt( const QPoint &point_ ) const {
...
QString PBTrashView::categoryAt( const QPoint &point_ ) const {
...
void PBTrashView::dataChanged( const QModelIndex &topLeft, const QModelIndex &bottomRight ) {

	hashIsDirty = true;
	QAbstractItemView::dataChanged( topLeft, bottomRight );
};

void PBTrashView::rowsInserted( const QModelIndex &parent, int start, int end ) {

	hashIsDirty = true;
	QAbstractItemView::rowsInserted( parent, start, end );
};

void PBTrashView::rowsAboutToBeRemoved( const QModelIndex &parent, int start, int end ) {

	hashIsDirty = true;
	QAbstractItemView::rowsAboutToBeRemoved( parent, start, end );
};

void PBTrashView::updateGeometries() {
...
QModelIndex PBTrashView::moveCursor( QAbstractItemView::CursorAction cursorAction, Qt::KeyboardModifiers ) {

	return moveCursorCategorized( cursorAction );
};

int PBTrashView::horizontalOffset() const {

	return horizontalScrollBar()->value();
};

int PBTrashView::verticalOffset() const {

	return verticalScrollBar()->value();
};

void PBTrashView::scrollContentsBy( int dx, int dy ) {

	scrollDirtyRegion( dx, dy );
	viewport()->scroll( dx, dy );
};

void PBTrashView::setSelection( const QRect &rect, QFlags<QItemSelectionModel::SelectionFlag> flags ) {
...
QRegion PBTrashView::visualRegionForSelection( const QItemSelection &selection ) const {
...
void PBTrashView::paintEvent( QPaintEvent* event ) {
...
void PBTrashView::resizeEvent( QResizeEvent* ) {

	hashIsDirty = true;
	calculateRectsIfNecessary();
};

void PBTrashView::mousePressEvent( QMouseEvent *mpEvent ) {
...
void PBTrashView::mouseMoveEvent( QMouseEvent *mmEvent ) {
...
void PBTrashView::mouseReleaseEvent( QMouseEvent *mrEvent ) {
...
void PBTrashView::mouseDoubleClickEvent( QMouseEvent *mEvent ) {

	mEvent->accept();
};

void PBTrashView::computeGridSize( QSize iconSize ) {
...
QModelIndex PBTrashView::moveCursorCategorized( QAbstractItemView::CursorAction cursorAction ) {
...
void PBTrashView::calculateRectsIfNecessary() const {
...
void PBTrashView::calculateCategorizedRects() const {
...
void PBTrashView::computeRowsAndColumns() const {
...
QRect PBTrashView::viewportRectForRow( int row ) const {
...
void PBTrashView::paintCategory( QPainter *painter, const QRect &rectangle, const QString &text ) const {
...
QPixmap PBTrashView::pixmapForCategory( QString categoryText ) const {
