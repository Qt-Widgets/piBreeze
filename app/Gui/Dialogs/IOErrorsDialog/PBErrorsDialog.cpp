/*
	*
	* PBErrorsDialog.cpp - PBErrorsDialog class
	*
*/
...
PBErrorsDialog::PBErrorsDialog( QString title, QString text, QStringList nodes, QWidget *parent ) : PBDialog( parent ) {
...
void PBErrorsDialog::setupGUI() {
	...
	okayBtn = new PBButton( QIcon( ":/icons/ok.png" ), "&Ok", this );
...
void PBErrorsDialog::setupTable() {
...
void PBErrorsDialog::addEntry( QString path ) {
...
void PBErrorsDialog::keyPressEvent( QKeyEvent *keyEvent ) {
...
void PBErrorsDialog::close() {

	PBDialog::close();
	emit closed();
};

int PBErrorsDialog::exec() {
