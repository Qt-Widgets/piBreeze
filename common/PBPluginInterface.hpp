/*
	*
	* PBPluginInterface.hpp - NewBreeze PluginInterface Class
	*
...
class PLUGIN_DLLSPEC PBPluginInterface {
	...
	public:
		...
		enum Type {
			Alternative				= 0x65F8E4,			// Alternative for the existing widget. Ex: Classic sidebar instead of PBSidePanel
...
QT_BEGIN_NAMESPACE
	Q_DECLARE_INTERFACE( PBPluginInterface, "com.NewBreeze.PBPluginInterface")
QT_END_NAMESPACE
