/*
	*
	* PBProgressBar.cpp - ProgressBar Class for PiBreeze
	*
*/

#include "PBProgressBar.hpp"

PBProgressBar::PBProgressBar( QWidget *parent ) : QWidget( parent ) {
...
void PBProgressBar::setValue( qreal value ) {
...
void PBProgressBar::setSway( bool sway ) {

	mSway = sway;
	swayTimer.start( 50, this );
};

void PBProgressBar::setProgressText( QString text ) {

	progressText = text;
};

void PBProgressBar::paintEvent( QPaintEvent *pEvent ) {
...
void PBProgressBar::timerEvent( QTimerEvent *tEvent ) {
