/*
	*
	* PBDeviceView.hpp - DeviceView class header file
	*
*/
...
class PBDeviceAction;
class PBDeviceMenu;

class PBDevicesIcon : public QWidget {
	Q_OBJECT
...
class PBDeviceAction : public QWidget {
	Q_OBJECT

	public:
		PBDeviceAction( PBDeviceInfo, QWidget* );
		QString mountPoint();
...
class PBDeviceMenu : public QMenu {
	Q_OBJECT

	public:
		PBDeviceMenu( QWidget *parent );
