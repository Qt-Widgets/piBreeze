/*
	*
	* PBFileInfoGatherer.cpp - PiBreeze FileInfoGatherer Class
	*
*/

#include "PBFileInfoGatherer.hpp"

PBQuickFileInfoGatherer::PBQuickFileInfoGatherer() {

	fileTypes = new QSettings( ":/data/PBFSExtData.conf", QSettings::NativeFormat );
};

QString PBQuickFileInfoGatherer::permStr( mode_t fileMode ) {
	QString permStr;
...
QString PBQuickFileInfoGatherer::formatSize( qint64 num ) {
...
QVariantList PBQuickFileInfoGatherer::getQuickFileInfo( QString path ) {
