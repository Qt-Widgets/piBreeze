/*
	*
	* PBDeviceInfoUnix.cpp - PBDeviceInfoPrivate Class for Unix
	*
*/
...
PBDeviceInfoPrivate::PBDeviceInfoPrivate() {
...
PBDeviceInfoPrivate::PBDeviceInfoPrivate( QString dev, QString mountPt, QString fs ) : QSharedData() {

	/* Check if the path provided and hence the PBDeviceInfo object is valid or not */
	mIsValid = true;
...
bool PBDeviceInfoPrivate::isValid() {

	return mIsValid;
};

void PBDeviceInfoPrivate::getDeviceLabel() {
...
void PBDeviceInfoPrivate::retrieveVolumeInfo() {
...
void PBDeviceInfoPrivate::getDeviceType( QString, QString ) {
};
