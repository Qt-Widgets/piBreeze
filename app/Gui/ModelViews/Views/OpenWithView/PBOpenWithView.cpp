/*
	*
	* PBAppsView.cpp - PiBreeze FolderView Class
	*
*/

#include "PBOpenWithView.hpp"

PBOpenWithView::PBOpenWithView() : QAbstractItemView() {
	...
	setItemDelegate( new PBOpenWithDelegate() );

	// Applications Model
	appModel = new PBItemViewModel();
	setModel( appModel );
	...
	appModel->setRootPath( "PB://Applications" );
};

void PBOpenWithView::setModel( QAbstractItemModel *model ) {

	QAbstractItemView::setModel( model );
	hashIsDirty = true;
};

int PBOpenWithView::categoryHeight() const {

	return myCategoryHeight;
};

void PBOpenWithView::setCategoryHeight( int newCategoryHeight ) {
...
int PBOpenWithView::itemHeight() const {

	return myItemHeight;
};

void PBOpenWithView::setItemHeight( int newItemHeight ) {
...
QSize PBOpenWithView::iconSize() const {

	return myIconSize;
};

void PBOpenWithView::setIconSize( QSize newIconSize ) {

	myIconSize = newIconSize;
	viewport()->update();
};

void PBOpenWithView::setIconSize( int nWidth, int nHeight ) {

	setIconSize( QSize( nWidth, nHeight ) );
};

QMargins PBOpenWithView::contentsMargins() const {

	return myContentsMargins;
};

void PBOpenWithView::setContentsMargins( QMargins newContentsMargins ) {
...
void PBOpenWithView::setContentsMargins( int nLeft, int nTop, int nRight, int nBottom ) {

	setContentsMargins( QMargins( nLeft, nTop, nRight, nBottom ) );
};

QMargins PBOpenWithView::inlayMargins() const {

	return myInlayMargins;
};

void PBOpenWithView::setInlayMargins( QMargins newInlayMargins ) {
...
void PBOpenWithView::setInlayMargins( int nLeft, int nTop, int nRight, int nBottom ) {
...
int PBOpenWithView::categorySpacing() const {

	return myCategorySpacing;
};

void PBOpenWithView::setCategorySpacing( int newCategorySpacing ) {
...
void PBOpenWithView::calculateRectsIfNecessary() const {
...
QRect PBOpenWithView::visualRect( const QModelIndex &index ) const {
...
QRect PBOpenWithView::viewportRectForRow( int row ) const {
...
QRect PBOpenWithView::categoryRect( int categoryIndex ) const {
...
void PBOpenWithView::scrollTo( const QModelIndex &index, QAbstractItemView::ScrollHint ) {
...
QModelIndex PBOpenWithView::indexAt( const QPoint &point_ ) const {
...
QString PBOpenWithView::categoryAt( const QPoint &point_ ) const {
...
void PBOpenWithView::dataChanged( const QModelIndex &topLeft, const QModelIndex &bottomRight ) {

	hashIsDirty = true;
	QAbstractItemView::dataChanged( topLeft, bottomRight );
};

void PBOpenWithView::rowsInserted( const QModelIndex &parent, int start, int end ) {

	hashIsDirty = true;
	QAbstractItemView::rowsInserted( parent, start, end );
};

void PBOpenWithView::rowsAboutToBeRemoved( const QModelIndex &parent, int start, int end ) {

	hashIsDirty = true;
	QAbstractItemView::rowsAboutToBeRemoved( parent, start, end );
};

QModelIndex PBOpenWithView::moveCursor( QAbstractItemView::CursorAction cursorAction, Qt::KeyboardModifiers ) {
...
int PBOpenWithView::horizontalOffset() const {

	return horizontalScrollBar()->value();
};

int PBOpenWithView::verticalOffset() const {

	return verticalScrollBar()->value();
};

void PBOpenWithView::scrollContentsBy( int dx, int dy ) {

	scrollDirtyRegion( dx, dy );
	viewport()->scroll( dx, dy );
};

void PBOpenWithView::setSelection( const QRect &rect, QFlags<QItemSelectionModel::SelectionFlag> flags ) {
...
void PBOpenWithView::paintEvent( QPaintEvent* event ) {
...
void PBOpenWithView::paintCategory( QPainter *painter, const QRect &rectangle, const QString &text ) const {
...
QPixmap PBOpenWithView::pixmapForCategory( QString categoryText ) const {
...
QRegion PBOpenWithView::visualRegionForSelection( const QItemSelection &selection ) const {
...
void PBOpenWithView::resizeEvent( QResizeEvent* ) {
...
void PBOpenWithView::updateGeometries() {
...
void PBOpenWithView::mousePressEvent( QMouseEvent *event ) {

	QAbstractItemView::mousePressEvent( event );
	setCurrentIndex( indexAt( event->pos() ) );
};

void PBOpenWithView::mouseDoubleClickEvent( QMouseEvent *event ) {
