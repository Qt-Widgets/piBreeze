...
#include "PBPushButton.hpp"

PBPushButton::PBPushButton( QWidget *parent ) : QPushButton( parent ) {
...
void PBPushButton::setFont( QFont newFont ) {
...
QString PBPushButton::text() {
	/* Return the button text */

	return mText;
};

void PBPushButton::setText( QString txt ) {
...
QString PBPushButton::description() {
	/*description() -> QString
...
void PBPushButton::setDescription( QString desc ) {
...
void PBPushButton::setIcon( QIcon icn ) {
	/*setIcon( QIcon ) -> None
...
void PBPushButton::setIconSize( QSize iSize ) {
...
QSize PBPushButton::minimumSizeHint() {
...
void PBPushButton::setCheckable( bool checkable ) {
...
void PBPushButton::setChecked( bool checked ) {
...
void PBPushButton::mousePressEvent( QMouseEvent *mEvent ) {
...
void PBPushButton::mouseReleaseEvent( QMouseEvent *mEvent ) {
...
void PBPushButton::resizeEvent( QResizeEvent *rEvent ) {
...
void PBPushButton::paintEvent( QPaintEvent *pEvent ) {
...
// int main( int argc, char *argv[] ) {
	...
	// PBPushButton *Gui = new PBPushButton();
