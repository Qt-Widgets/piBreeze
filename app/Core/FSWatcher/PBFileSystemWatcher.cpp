/*
	*
	* PBFileSystemWatcher.cpp - Advanced version of QFileSystemWatcher for Qt4/5
	*
*/

#include "PBFileSystemWatcher.hpp"
...
PBFileSystemWatcher::PBFileSystemWatcher() : QFileSystemWatcher() {
...
void PBFileSystemWatcher::startWatch( QString path ) {
...
void PBFileSystemWatcher::stopWatch() {
...
void PBFileSystemWatcher::handleChanged( QString cPath ) {
