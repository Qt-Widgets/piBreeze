/*
	*
	* PBPreviewWidget.hpp - PiBreeze PreviewWidget Classes
	*
*/

#include "PBFolderFlash.hpp"

PBFolderFlash::PBFolderFlash( QString pth, QWidget *parent ) : QWidget( parent ) {
...
void PBFolderFlash::createGUI() {
	...
	peekWidgetBase = new PBIconViewRestricted( new PBItemViewModel(), this );
	peekWidgetBase->setObjectName( tr( "previewBase" ) );
	qobject_cast<PBItemViewModel*>( peekWidgetBase->model() )->setRootPath( path );
...
void PBFolderFlash::setWindowProperties() {
...
void PBFolderFlash::keyPressEvent( QKeyEvent *keyEvent ) {
...
void PBFolderFlash::changeEvent( QEvent *event ) {
...
void PBFolderFlash::paintEvent( QPaintEvent *pEvent ) {
