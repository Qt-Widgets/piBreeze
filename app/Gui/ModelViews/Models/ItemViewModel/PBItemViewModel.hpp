/*
	*
	* PBPBItemViewModel.hpp - PiBreeze PBItemViewModel Class Header
	*
*/
...
class PBItemViewModel : public QAbstractItemModel {
    Q_OBJECT
	...
	public:
		...
		PBItemViewModel( QObject *parent = 0 );
		~PBItemViewModel();
	...
	private:
		...
		PBQuickFileInfoGatherer *quickDataGatherer;
		PBFileSystemWatcher *watcher;
