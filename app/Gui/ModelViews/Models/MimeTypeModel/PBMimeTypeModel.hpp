/*
	*
	* PBPBMimeTypeModel.hpp - PiBreeze PBMimeTypeModel Class Header
	*
*/
...
class PBMimeIconUpdater : public QThread {
	Q_OBJECT

		public:
		PBMimeIconUpdater( QString, QStringList, bool *term );
		~PBMimeIconUpdater();
...
class PBMimeTypeModel : public QAbstractItemModel {
    Q_OBJECT
